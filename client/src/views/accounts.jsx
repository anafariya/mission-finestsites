...
import { AuthContext, ViewContext, Card, Table, Animate, usePlans, useAPI, useNavigate } from 'components/lib';
      ...
      <Card loading={ false }>
        ...
        <Table
          ...
          actions={{ 
            ...
            custom: [{ icon: 'dollar-sign', action: (d) => router(`/payment-history/${d.id}`) }]
          }}
        />
